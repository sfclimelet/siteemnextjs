...
"[project]/components/navbar/navbar-hover.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function enableNavbarHover() {
    const DROPDOWN_DELAY_OPEN = 120; // tempo para abrir
    const DROPDOWN_DELAY_CLOSE = 260; // tempo para fechar
    ...
    dropdowns.forEach((drop)=>{
        ...
        drop.addEventListener("mouseleave", ()=>{
            ...
            }, DROPDOWN_DELAY_CLOSE);
        });
        // ========================= MOBILE (touch) =========================
        button.addEventListener("touchstart", (e)=>{
            e.preventDefault();
            // Se já está aberto → fecha
            if (drop.classList.contains("touch-open")) {
                drop.classList.remove("touch-open");
                return;
            }
    ...
    // Fecha menus ao tocar fora no mobile
    ...
    // ================================================================
    function closeAll(list, except = null) {
        list.forEach((item)=>{
            if (item !== except) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$navbar$2f$navbar$2d$hover$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/navbar/navbar-hover.js [app-ssr] (ecmascript)");
// Ícones Lucide
...
function NavbarHome() {
    // NAVBAR
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$navbar$2f$navbar$2d$hover$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enableNavbarHover"])();
...
//# sourceMappingURL=_0f15056d._.js.map