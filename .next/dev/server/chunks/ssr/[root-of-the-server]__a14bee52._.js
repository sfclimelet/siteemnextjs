...
(()=>{
    const e = new Error("Cannot find module '@/utils/paginas-indisponiveis-aviso'");
...
function CarrosselHome() {
    ...
    const handlerPageIndisponivel = (id)=>{
        if (pagesIndisponiveis.includes(id)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a14bee52._.js.map